...
:: Hidden Files Restores v4.5
:: THIS SCRIPTS WERE WROTE BY IVANDRO ISMAEL GOMES JAO
@Echo off && Cls
	setlocal enabledelayedexpansion
:Menu
	Title Hidden Files ^& Folder Restorer (v4.5) by: Ivandro Ismael
	color a && Cls
	Echo.
	Echo.
	Echo               ======================================================
...
:submenu
	...
	Set /p "x=Type (y/n): "
		...
		If /i "!x:~0,1!" == "y" (
			...
			echo ========================================
			echo Email #1: ivandrofly@gmail.com
			Echo Email #2: ivandrofly@outlook.com
			echo Email #3: ivandrofly@hotmail.com
			echo Email #4: anonymous2207@hotmail.com
			echo Or you can follow me on Twitter by @ivandrofly ^| @ivandrojao
			echo ========================================
			Echo ---^> [!x!]
			Pause >nul && Cls && Goto :submenu
		)
